...
T = TypeVar("T", bound="PostStockProductsByBarcodeBarcodeTransferBody")


@_attrs_define
class PostStockProductsByBarcodeBarcodeTransferBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_stock_products_by_barcode_barcode_transfer_body = cls(
            amount=amount,
        ...
        post_stock_products_by_barcode_barcode_transfer_body.additional_properties = d
        return post_stock_products_by_barcode_barcode_transfer_body
