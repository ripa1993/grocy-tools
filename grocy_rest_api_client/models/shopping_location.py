...
if TYPE_CHECKING:
    from ..models.shopping_location_userfields import ShoppingLocationUserfields


T = TypeVar("T", bound="ShoppingLocation")
...
class ShoppingLocation:
    ...
    Attributes:
        ...
        userfields (Union[Unset, ShoppingLocationUserfields]): Key/value pairs of userfields
    """
    ...
    userfields: Union[Unset, "ShoppingLocationUserfields"] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        userfields: Union[Unset, ShoppingLocationUserfields]
        if isinstance(_userfields, Unset):
            userfields = UNSET
        else:
            userfields = ShoppingLocationUserfields.from_dict(_userfields)

        shopping_location = cls(
            id=id,
            name=name,
        ...
        shopping_location.additional_properties = d
