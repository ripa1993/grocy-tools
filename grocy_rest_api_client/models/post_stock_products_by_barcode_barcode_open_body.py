...
T = TypeVar("T", bound="PostStockProductsByBarcodeBarcodeOpenBody")


@_attrs_define
class PostStockProductsByBarcodeBarcodeOpenBody:
    """
    Example:
        {'amount': 1}
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_stock_products_by_barcode_barcode_open_body = cls(
            amount=amount,
            stock_entry_id=stock_entry_id,
            allow_subproduct_substitution=allow_subproduct_substitution,
        )

        post_stock_products_by_barcode_barcode_open_body.additional_properties = d
        return post_stock_products_by_barcode_barcode_open_body
