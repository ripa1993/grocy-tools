...
T = TypeVar("T", bound="ProductWithoutUserfields")


@_attrs_define
class ProductWithoutUserfields:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        product_without_userfields = cls(
            id=id,
            name=name,
        ...
        product_without_userfields.additional_properties = d
        return product_without_userfields
