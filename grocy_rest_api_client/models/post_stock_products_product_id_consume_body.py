...
T = TypeVar("T", bound="PostStockProductsProductIdConsumeBody")


@_attrs_define
class PostStockProductsProductIdConsumeBody:
    """
    Example:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_stock_products_product_id_consume_body = cls(
            amount=amount,
        ...
        post_stock_products_product_id_consume_body.additional_properties = d
        return post_stock_products_product_id_consume_body
