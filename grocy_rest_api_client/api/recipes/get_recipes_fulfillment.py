...
) -> Optional[Union[Error400, Error500, List["RecipeFulfillmentResponse"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = RecipeFulfillmentResponse.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error400, Error500, List["RecipeFulfillmentResponse"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Error400, Error500, List['RecipeFulfillmentResponse']]
    """
