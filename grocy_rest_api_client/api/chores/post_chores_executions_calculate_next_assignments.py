...
from ...models.post_chores_executions_calculate_next_assignments_body import (
...
def _get_kwargs(
    *,
    body: PostChoresExecutionsCalculateNextAssignmentsBody,
) -> Dict[str, Any]:
...
def sync_detailed(
    *,
    ...
    Args:
        body (PostChoresExecutionsCalculateNextAssignmentsBody):  Example: {'chore_id': 1}.
