...
from ...models.post_stock_products_by_barcode_barcode_consume_body import PostStockProductsByBarcodeBarcodeConsumeBody
...
def _get_kwargs(
    barcode: str,
    *,
    body: PostStockProductsByBarcodeBarcodeConsumeBody,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        barcode (str):
        body (PostStockProductsByBarcodeBarcodeConsumeBody):  Example: {'amount': 1,
            'transaction_type': 'consume', 'spoiled': False}.
