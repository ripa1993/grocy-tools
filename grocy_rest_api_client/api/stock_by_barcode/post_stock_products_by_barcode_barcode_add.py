...
from ...models.post_stock_products_by_barcode_barcode_add_body import PostStockProductsByBarcodeBarcodeAddBody
...
def _get_kwargs(
    barcode: str,
    *,
    body: PostStockProductsByBarcodeBarcodeAddBody,
) -> Dict[str, Any]:
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        barcode (str):
        body (PostStockProductsByBarcodeBarcodeAddBody):  Example: {'amount': 1,
            'best_before_date': '2019-01-19', 'transaction_type': 'purchase', 'price': '1.99'}.
