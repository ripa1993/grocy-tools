...
from ...models.post_stock_products_product_id_inventory_body import PostStockProductsProductIdInventoryBody
...
def _get_kwargs(
    product_id: int,
    *,
    body: PostStockProductsProductIdInventoryBody,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/stock/products/{product_id}/inventory",
    }
