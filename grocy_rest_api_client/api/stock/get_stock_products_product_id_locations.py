...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: Dict[str, Any] = {
        "method": "get",
        "url": f"/stock/products/{product_id}/locations",
        "params": params,
    }
...
) -> Optional[Union[Error400, Error500, List["StockLocation"]]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = StockLocation.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Error400, Error500, List["StockLocation"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[Error400, Error500, List['StockLocation']]
    """
