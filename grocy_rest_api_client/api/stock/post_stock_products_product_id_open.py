...
from ...models.post_stock_products_product_id_open_body import PostStockProductsProductIdOpenBody
...
def _get_kwargs(
    product_id: int,
    *,
    body: PostStockProductsProductIdOpenBody,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/stock/products/{product_id}/open",
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        product_id (int):
        body (PostStockProductsProductIdOpenBody):  Example: {'amount': 1}.
