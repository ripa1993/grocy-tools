...
from ...models.post_stock_products_product_id_consume_body import PostStockProductsProductIdConsumeBody
...
def _get_kwargs(
    product_id: int,
    *,
    body: PostStockProductsProductIdConsumeBody,
) -> Dict[str, Any]:
    headers: Dict[str, Any] = {}

    _kwargs: Dict[str, Any] = {
        "method": "post",
        "url": f"/stock/products/{product_id}/consume",
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        product_id (int):
        body (PostStockProductsProductIdConsumeBody):  Example: {'amount': 1, 'transaction_type':
            'consume', 'spoiled': False}.
